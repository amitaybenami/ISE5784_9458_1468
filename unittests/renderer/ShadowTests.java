...
public class ShadowTests {
   ...
   public void sphereTriangleMove1() {
      sphereTriangleHelper("shadowSphereTriangleMove1", //
                           new Triangle(new Point(-61,-32,0), new Point(-31,-62,0), new Point(-59,-60,-4)), //
                           new Point(-100, -100, 200));
   }
   ...
   public void sphereTriangleMove2() {
      sphereTriangleHelper("shadowSphereTriangleMove2", //
                           new Triangle(new Point(-48,-20,0), new Point(-18,-50,0), new Point(-46,-48,-4)), //
                           new Point(-100, -100, 200));
   }
   ...
   public void trianglesSphere() {
      ...
      camera.setImageWriter(new ImageWriter("shadowTrianglesSphere", 600, 600).setAmountOfSamples(9))
         .build()
         .renderImage()
         .writeToImage();
   }
