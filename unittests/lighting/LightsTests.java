...
public class LightsTests {
   ...
   public void sphereAll(){
      scene1.geometries.add(sphere);
      scene1.lights.add(new DirectionalLight(sphereLightColor, new Vector(0,1,0)));
      scene1.lights.add(new PointLight(sphereLightColor, new Point(20,100,0))
              .setKl(0.001).setKq(0.0002));
      scene1.lights
              .add(new SpotLight(sphereLightColor, new Point(-70,0,80), new Vector(70, 0, -130))
                      .setKl(0.001).setKq(0.00004).setNarrowBeam(30));

      camera1.setImageWriter(new ImageWriter("sphereAll", 500, 500))
              .build()
              .renderImage()
              .writeToImage();
   ...
   public void trianglesAll() {
      scene2.geometries.add(triangle1, triangle2);
      scene2.lights.add(new SpotLight(trianglesLightColor, new Point(30,-50,-100), trianglesLightDirection)
              .setKl(0.001).setKq(0.00004).setNarrowBeam(10));
      scene2.lights.add(new PointLight(trianglesLightColor, trianglesLightPosition)
              .setKl(0.001).setKq(0.0002));
      scene2.lights.add(new DirectionalLight(trianglesLightColor, vertices[0].subtract(vertices[2])));

      camera2.setImageWriter(new ImageWriter("trianglesAll", 500, 500))
              .build()
              .renderImage()
              .writeToImage();
   }
