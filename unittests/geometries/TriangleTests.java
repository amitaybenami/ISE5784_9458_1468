...
class TriangleTests {
    ...
    void testFindGeoIntersectionsHelper(){
        ...
        List<Point> result1 = triangle.findIntersections(new Ray(p111,vM0_3M0_3M1),2);
        assertEquals(1,result1.size(),"Wrong number of points");
        assertEquals(List.of(p0_70_70),result1,"Point is inside the distance");
        // TC02: Point is outside the distance (0 points)
        assertNull(triangle.findIntersections(new Ray(p111,vM0_3M0_3M1),1),"Point is outside the distance");
        // =============== Boundary Values Tests ==================
        //TC11: Point is on distance (1 point)
        List<Point> result2 = triangle.findIntersections(new Ray(p111,vM0_3M0_3M1),1.0862780491200215);
